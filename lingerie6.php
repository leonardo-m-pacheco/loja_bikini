	...
	<div id="divpoderosa">
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
				...
				<img src="imagens/lingerie/conjunto coracao coral.jpeg" alt="fotoproduto" width="100%">

			</div>
			
		</div>
			<div class="descricaoproduto">		
				<h1>Conjunto Coração Coral - Neon</h1>
				<ul>
					<li>Tamanho: M</li>
				</ul>
				<ul>
					<li>Descrição:</li>
					<li>Conjunto meia taça em formato de coração invertido</li>
					<li>Sem bojo</li>
					<li>Código do produto: K7F</li>
				</ul>
					<ul>
					<li>Preço: R$ 36,00</li>
				</ul>
				<div id="formulario">
				<form action="lingerie6.php" method="POST">
					<fieldset>
