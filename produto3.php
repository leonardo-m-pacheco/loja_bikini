	...
	<div id="divpoderosa">
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
				...
				<img src="imagens/Catálogo/Produto3.jpeg" alt="fotoproduto" width="100%">

			</div>

			<div class="mySlides fade">
				<div class="numbertext">2 / 3</div>
				<img src="imagens/imagens_prod3/prod.3.jpeg" alt="fotoproduto" width="100%">

			</div>

			<div class="mySlides fade">
				<div class="numbertext">3 / 3</div>
				<img src="imagens/imagens_prod3/prod.3(1).jpeg" alt="fotoproduto" width="100%">
