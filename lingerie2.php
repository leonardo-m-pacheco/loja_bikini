	...
	<div id="divpoderosa">
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
				...
				<img src="imagens/lingerie/aro colors azul.jpeg" alt="fotoproduto" width="100%">

			</div>
			
		</div>
			<div class="descricaoproduto">		
				<h1>Aro Colors Azul Bebê - Neon</h1>
				<ul>
					<li>Tamanho: GG</li>
				</ul>
				<ul>
					...
					<li>Sem bojo</li>
					<li>Código do produto: LL9</li>
				</ul>
					<ul>
					<li>Preço: R$ 35,00</li>
				</ul>
				<div id="formulario">
				<form action="lingerie2.php" method="POST">
					<fieldset>
