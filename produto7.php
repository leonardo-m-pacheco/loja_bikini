	...
	<div id="divpoderosa">
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
				...
				<img src="imagens/Catálogo/Produto7.jpeg" alt="fotoproduto" width="100%">
			...
			<div class="descricaoproduto">		
				<h1>Biquíni Mali Laranja</h1>
				<ul>
					<li>Tamanho:P</li>
				</ul>
				<ul>
					<li>Descrição:</li>
					<li>Meia taça sem bojo alça grossa</li>
				...
				<div id="formulario">
				<form action="produto7.php" method="POST">
					<fieldset>
