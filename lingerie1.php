	...
	<div id="divpoderosa">
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
			  ...
			  <img src="imagens/lingerie/pavão verde com pink/pavao.jpeg" alt="fotoproduto"width="100%">
			  
			</div>
			
			<div class="mySlides fade">
			  <div class="numbertext">2 / 2</div>
			  <img src="imagens/lingerie/pavão verde com pink/pavao1.jpeg"  alt="fotoproduto"width="100%">
		...
		<div class="descricaoproduto">		
				<h1>Pavão Verde com Pink</h1>
				<ul>
					<li>Tamanho: G</li>
				</ul>
				<ul>
					<li>Descrição:</li>
					<li>Conjunto de renda com calcinha tanga</li>
					<li>Sem bojo</li>
					<li>Código do produto: 417</li>
				</ul>
					<ul>
					<li>Preço: R$ 32,00</li>
				</ul>
