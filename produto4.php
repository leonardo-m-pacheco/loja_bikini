	...
	<div id="divpoderosa">
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
			  ...
			  <img src="imagens/Catálogo/Produto4.jpeg" alt="fotoproduto"width="100%">
			  
			</div>
			
			<div class="mySlides fade">
			  <div class="numbertext">2 / 3</div>
			  <img src="imagens/imagens_prod4/produto4 (1).jpeg"  alt="fotoproduto"width="100%">
			  
			</div>
			
			<div class="mySlides fade">
			  <div class="numbertext">3 / 3</div>
			  <img src="imagens/imagens_prod4/produto4 (2).jpeg"  alt="fotoproduto"width="100%">
			...
			<h1>Biquíni retrô canelado oncinha</h1>
			<ul>
				<li>Tamanho:P</li>
			</ul>
			<ul>
				<li>Descrição:</li>
				<li>Meia taça sem bojo</li>
				<li>Biquíni retrô com asa delta meio fio dental</li>
				<li>Tecido canelado de onça com brilho</li>
				<li>Código do produto: 266</li>
			</ul>
				<ul>
				<li>Preço: R$ 135,00</li>
			</ul>
			<div id="formulario">
